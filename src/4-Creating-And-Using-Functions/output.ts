...
type ProductType = {
  id: number,
  name: string,
  icon?: string // The ? means the icon is optional
}
...
function runTheLearningSamples() {
  // hoisted: means a function is lifted up to the top of the page during compilation
  ...
  // ...restOfAddress. The three dots before the parameter means it a rest parameter
  // A join() function will join all the element in the array with whatever separator we pass in
  ...
  /*Destructuring helps you to go inside of objects and
    then get those values out and use them inside of functions
    Destructuring might make your code less readable. */
